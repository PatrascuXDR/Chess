...
const int n = 8;
bool mutare = 1, remalb, remneg, recitire, reluare, veriff, rocadalb = 1, rocadneg = 1;
void MainMenu()
{
    system("cls");
                ...
                while (reluare){
                    if (mutare){
                        ...
                        while (c != ' '){
                            c = getch();
                            if (c == '=') remalb = 1;
                            if (remneg && remalb) {cout << "\nREMIZA. "; reluare = 0; break;}
                            if (c == '=') {remalb = 1; cout << "= ";}
                            if (c == '-') {cout << "\nALBUL A CEDAT. "; reluare = 0; break;}
                            if (c == 'w') cursor[0] --;
                            else if (c == 's') cursor[0] ++;
                            else if (c == 'a') cursor[1] --;
                            else if (c == 'd') cursor[1] ++;
                        ...
                        if (veriff == 1 && a[xx][yy] == 'k') {a[xx][yy] = a[x][y]; a[x][y] = NULL; afisare(); cout << "\n\nALBUL A CASTIGAT\n"; recitire = 0; break;}
                        ...
                        while (c != ' '){
                            ...
                            if (remneg && remalb) {cout << "\nREMIZA. "; reluare = 0; break;}
                            if (c == '=') {remalb = 1; cout << "= ";}
                            if (c == '-') {cout << "\nNEGRUL A CEDAT. "; reluare = 0; break;}
                            if (c == 'w') cursor[0] --;
                            else if (c == 's') cursor[0] ++;
                            else if (c == 'a') cursor[1] --;
                            else if (c == 'd') cursor[1] ++;
